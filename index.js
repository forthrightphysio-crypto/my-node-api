...
app.get("/video/:filename", async (req, res) => {
  ...
  try {
    ...
    const tempUrl = `https://f000.backblazeb2.com/file/${process.env.B2_BUCKET_NAME}/${encodeURIComponent(filename)}?Authorization=${downloadResponse.data.authorizationToken}`;

    // Send URL in JSON (or redirect directly)
